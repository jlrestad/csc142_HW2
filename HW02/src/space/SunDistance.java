...
public class SunDistance {  
	public double MERCURY = 5.79*Math.pow(10, 10);
	public double VENUS = 1.08*Math.pow(10, 11);
	public double EARTH = 1.50*Math.pow(10, 11);
	public double MARS = 2.28*Math.pow(10, 11);
	public double JUPITER = 7.78*Math.pow(10, 11);
	public double SATURN = 1.43*Math.pow(10, 12);
